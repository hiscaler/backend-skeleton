    ...
    <div class="page-login">
        ...
        <div class="bd">
            ...
            <div class="weui-cells weui-cells_form">
                <?= $form->field($model, 'username', $options)->textInput(['class' => 'weui-input', 'placeholder' => '请填写登录账号']) ?>

                <?= $form->field($model, 'password', $options)->passwordInput(['class' => 'weui-input', 'placeholder' => '请填写登录密码']) ?>
            </div>
            <div class="weui-btn-area">
                <?= Html::submitButton('登录', ['class' => 'weui-btn weui-btn_primary weui-btn_disabled']) ?>
            </div>
            <?php ActiveForm::end(); ?>
        </div>
    </div>

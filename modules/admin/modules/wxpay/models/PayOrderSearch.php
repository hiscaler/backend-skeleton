...
use app\modules\admin\modules\wxpay\models\PayOrder;

/**
 * PayOrderSearch represents the model behind the search form of `app\modules\admin\modules\wxpay\models\PayOrder`.
 */

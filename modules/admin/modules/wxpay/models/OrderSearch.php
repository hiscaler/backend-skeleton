...
class OrderSearch extends Order
{
    ...
    public function rules()
    {
        return [
            ...
            [['appid', 'mch_id', 'device_info', 'nonce_str', 'sign', 'sign_type', 'transaction_id', 'out_trade_no', 'body', 'detail', 'attach', 'fee_type', 'spbill_create_ip', 'goods_tag', 'trade_type', 'product_id', 'limit_pay', 'openid'], 'safe'],
        ];
    }

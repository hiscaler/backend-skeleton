 ...
 */
class m180118_062429_create_wechat_order_table extends Migration
{
    ...
    public function up()
    {
        $this->createTable('{{%wechat_order}}', [
            ...
            'time_start' => $this->integer()->notNull()->comment('订单生成时间'),
            'time_expire' => $this->integer()->comment('订单失效时间'),
            'time_end' => $this->integer()->comment('订单结束时间'),
